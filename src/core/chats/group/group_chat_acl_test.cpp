...
TEST(PermissionsTest, MakePermissionsMultiple) {
  auto perms = MakePermissions(EPermission::PostMessage, EPermission::ChangeData);
...
TEST(PermissionsTest, MakePermissionsAllPermissions) {
  auto perms = MakePermissions(EPermission::PostMessage, EPermission::ChangeMembers, EPermission::ChangeData,
