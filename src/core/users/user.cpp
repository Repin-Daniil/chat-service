...
void TUser::UpdateDisplayName(const TDisplayName& display_name) {
  DisplayName_ = display_name.Value();
}

void TUser::UpdateBiography(const TBiography& biography) {
  Biography_ = biography.Value();
}
...
void TUser::UpdateUsername(const TUsername& username) {
